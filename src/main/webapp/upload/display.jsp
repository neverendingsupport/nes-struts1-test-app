...
<body>
<p>
<b>The Text:</b>&nbsp;<%= StringEscapeUtils.escapeHtml4(request.getAttribute("text").toString()) %>
</p>
<p>
...
<h3>Request Parameters</h3>
    ...
    <b>The Text:</b>&nbsp;<%= StringEscapeUtils.escapeHtml4(request.getParameter("theText").toString()) %></br>
